...
urlpatterns = (
    ...
    url(r'^firefox/desktop', views.product_desktop, name='firefox.desktop.index'),
    ...
    page('firefox/focus', 'firefox/focus.html'),
    page('firefox/geolocation', 'firefox/geolocation.html'),
    page('firefox/interest-dashboard', 'firefox/interest-dashboard.html'),
    url(r'^firefox/android', views.product_android, name='firefox.android.index'),
    page('firefox/android/faq', 'firefox/android/faq.html'),
    url(r'^firefox/ios', views.product_ios, name='firefox.ios'),
